...
首页扫码后会自动解析桌号，当前兼容以下二维码内容：

- 纯数字桌号，例如 `12`
- 带 `tableId` 参数的地址，例如 `pages/home/index?tableId=12`
- 带 `scene` 参数的二维码内容
- 现有商家后台生成的 H5 桌码，例如 `/c/login/12`

也就是说，现阶段就算桌台二维码还是旧的 Web 链接，也可以直接扫码进入小程序首页并识别桌号。
