...
CREATE TABLE IF NOT EXISTS session_checkout (
    ...
    self_service_count INTEGER DEFAULT 0,
    self_service_unit_price INTEGER DEFAULT 0,
    self_service_amount INTEGER DEFAULT 0,
    tableware_count INTEGER DEFAULT 0,
    tableware_unit_price INTEGER DEFAULT 0,
    tableware_amount INTEGER DEFAULT 0,
    customer_id INTEGER,
